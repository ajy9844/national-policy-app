...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    private static String DB_NAME ="policy.db";
    ...
    public void createDataBase() throws IOException
    {
        ...
        if(!mDataBaseExist)
        {
            ...
            try
            {
                ...
                copyDataBase();
                Log.e(TAG, "createDatabase(): database is created!"); // "createDatabase database created"
            }
    ...
    // "/data/data/your_package/databases/db_file" <-이 경로에서 데이터베이스가 존재하는지 확인한다
